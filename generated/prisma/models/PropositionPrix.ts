...
// @ts-nocheck 
/*
 * This file exports the `PropositionPrix` model and its related types.
 *
...
export type PropositionPrixAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which PropositionPrix to aggregate.
   */
  where?: Prisma.PropositionPrixWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   * 
   * Determine the order of PropositionPrixes to fetch.
   */
   ...
   * 
   * Take `±n` PropositionPrixes from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   * 
   * Skip the first `n` PropositionPrixes.
   */
  skip?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Count returned PropositionPrixes
  **/
...
export type GetPropositionPrixAggregateType<T extends PropositionPrixAggregateArgs> = {
      [P in keyof T & keyof AggregatePropositionPrix]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePropositionPrix[P]>
    : Prisma.GetScalarType<T[P], AggregatePropositionPrix[P]>
}
...
export type GetPropositionPrixGroupByPayload<T extends PropositionPrixGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PropositionPrixGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PropositionPrixGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PropositionPrixGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PropositionPrixGroupByOutputType[P]>
      }
    >
  >
...
export type PropositionPrixCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PropositionPrixFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PropositionPrixDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PropositionPrix'], meta: { name: 'PropositionPrix' } }
  /**
   * Find zero or one PropositionPrix that matches the filter.
   * @param {PropositionPrixFindUniqueArgs} args - Arguments to find a PropositionPrix
   * @example
   * // Get one PropositionPrix
   * const propositionPrix = await prisma.propositionPrix.findUnique({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find one PropositionPrix that matches the filter or throw an error with `error.code='P2025'`
   * if no matches were found.
   * @param {PropositionPrixFindUniqueOrThrowArgs} args - Arguments to find a PropositionPrix
   * @example
   * // Get one PropositionPrix
   * const propositionPrix = await prisma.propositionPrix.findUniqueOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first PropositionPrix that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PropositionPrixFindFirstArgs} args - Arguments to find a PropositionPrix
   * @example
   * // Get one PropositionPrix
   * const propositionPrix = await prisma.propositionPrix.findFirst({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first PropositionPrix that matches the filter or
   * throw `PrismaKnownClientError` with `P2025` code if no matches were found.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PropositionPrixFindFirstOrThrowArgs} args - Arguments to find a PropositionPrix
   * @example
   * // Get one PropositionPrix
   * const propositionPrix = await prisma.propositionPrix.findFirstOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find zero or more PropositionPrixes that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PropositionPrixFindManyArgs} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all PropositionPrixes
   * const propositionPrixes = await prisma.propositionPrix.findMany()
   * 
   * // Get first 10 PropositionPrixes
   * const propositionPrixes = await prisma.propositionPrix.findMany({ take: 10 })
   * 
   * // Only select the `id`
   * const propositionPrixWithIdOnly = await prisma.propositionPrix.findMany({ select: { id: true } })
   * 
   */
  ...
  /**
   * Create a PropositionPrix.
   * @param {PropositionPrixCreateArgs} args - Arguments to create a PropositionPrix.
   * @example
   * // Create one PropositionPrix
   * const PropositionPrix = await prisma.propositionPrix.create({
   *   data: {
   *     // ... data to create a PropositionPrix
   *   }
   * })
   * 
   */
  ...
  /**
   * Create many PropositionPrixes.
   * @param {PropositionPrixCreateManyArgs} args - Arguments to create many PropositionPrixes.
   * @example
   * // Create many PropositionPrixes
   * const propositionPrix = await prisma.propositionPrix.createMany({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
  ...
  /**
   * Create many PropositionPrixes and returns the data saved in the database.
   * @param {PropositionPrixCreateManyAndReturnArgs} args - Arguments to create many PropositionPrixes.
   * @example
   * // Create many PropositionPrixes
   * const propositionPrix = await prisma.propositionPrix.createManyAndReturn({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   * 
   * // Create many PropositionPrixes and only return the `id`
   * const propositionPrixWithIdOnly = await prisma.propositionPrix.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
  ...
  /**
   * Delete a PropositionPrix.
   * @param {PropositionPrixDeleteArgs} args - Arguments to delete one PropositionPrix.
   * @example
   * // Delete one PropositionPrix
   * const PropositionPrix = await prisma.propositionPrix.delete({
   *   where: {
   *     // ... filter to delete one PropositionPrix
   *   }
   * })
   * 
   */
  ...
  /**
   * Update one PropositionPrix.
   * @param {PropositionPrixUpdateArgs} args - Arguments to update one PropositionPrix.
   * @example
   * // Update one PropositionPrix
   * const propositionPrix = await prisma.propositionPrix.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Delete zero or more PropositionPrixes.
   * @param {PropositionPrixDeleteManyArgs} args - Arguments to filter PropositionPrixes to delete.
   * @example
   * // Delete a few PropositionPrixes
   * const { count } = await prisma.propositionPrix.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Update zero or more PropositionPrixes.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PropositionPrixUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many PropositionPrixes
   * const propositionPrix = await prisma.propositionPrix.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Update zero or more PropositionPrixes and returns the data updated in the database.
   * @param {PropositionPrixUpdateManyAndReturnArgs} args - Arguments to update many PropositionPrixes.
   * @example
   * // Update many PropositionPrixes
   * const propositionPrix = await prisma.propositionPrix.updateManyAndReturn({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: [
   ...
   * })
   * 
   * // Update zero or more PropositionPrixes and only return the `id`
   * const propositionPrixWithIdOnly = await prisma.propositionPrix.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  /**
   * Create or update one PropositionPrix.
   * @param {PropositionPrixUpsertArgs} args - Arguments to update or create a PropositionPrix.
   * @example
   * // Update or create a PropositionPrix
   * const propositionPrix = await prisma.propositionPrix.upsert({
   *   create: {
   *     // ... data to create a PropositionPrix
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the PropositionPrix we want to update
   *   }
   * })
   */
  ...
  /**
   * Count the number of PropositionPrixes.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PropositionPrixCountArgs} args - Arguments to filter PropositionPrixes to count.
   * @example
   * // Count the number of PropositionPrixes
   * const count = await prisma.propositionPrix.count({
   *   where: {
   *     // ... the filter for the PropositionPrixes we want to count
   *   }
   * })
  **/
  count<T extends PropositionPrixCountArgs>(
    args?: Prisma.Subset<T, PropositionPrixCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PropositionPrixCountAggregateOutputType>
      : number
  >

  /**
   * Allows you to perform aggregations operations on a PropositionPrix.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PropositionPrixAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
   * @example
  ...
  **/
  ...
  /**
   * Group by PropositionPrix.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PropositionPrixGroupByArgs} args - Group by arguments.
   * @example
  ...
  **/
  groupBy<
    T extends PropositionPrixGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PropositionPrixGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPropositionPrixGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 * Fields of the PropositionPrix model
 */
readonly fields: PropositionPrixFieldRefs;
}

/**
 * The delegate class that acts as a "Promise-like" for PropositionPrix.
...
export type PropositionPrixFindUniqueArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  /**
   * Filter, which PropositionPrix to fetch.
   */
  where: Prisma.PropositionPrixWhereUniqueInput
}

/**
 * PropositionPrix findUniqueOrThrow
 */
...
export type PropositionPrixFindFirstArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for searching for PropositionPrixes.
   */
  cursor?: Prisma.PropositionPrixWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type PropositionPrixFindManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PropositionPrixInclude<ExtArgs> | null
  /**
   * Filter, which PropositionPrixes to fetch.
   */
  where?: Prisma.PropositionPrixWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for listing PropositionPrixes.
   */
  cursor?: Prisma.PropositionPrixWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type PropositionPrixCreateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to create many PropositionPrixes.
   */
...
/**
 * PropositionPrix createManyAndReturn
 */
...
export type PropositionPrixUpdateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PropositionPrixInclude<ExtArgs> | null
  /**
   * The data needed to update a PropositionPrix.
   */
  data: Prisma.XOR<Prisma.PropositionPrixUpdateInput, Prisma.PropositionPrixUncheckedUpdateInput>
  /**
   * Choose, which PropositionPrix to update.
   */
  where: Prisma.PropositionPrixWhereUniqueInput
}

/**
 * PropositionPrix updateMany
 */
export type PropositionPrixUpdateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to update PropositionPrixes.
   */
  data: Prisma.XOR<Prisma.PropositionPrixUpdateManyMutationInput, Prisma.PropositionPrixUncheckedUpdateManyInput>
  /**
   * Filter which PropositionPrixes to update
   */
  where?: Prisma.PropositionPrixWhereInput
  /**
   * Limit how many PropositionPrixes to update.
   */
  limit?: number
}

/**
 * PropositionPrix updateManyAndReturn
 */
...
export type PropositionPrixUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PropositionPrixInclude<ExtArgs> | null
  /**
   * The filter to search for the PropositionPrix to update in case it exists.
   */
  where: Prisma.PropositionPrixWhereUniqueInput
  /**
   * In case the PropositionPrix found by the `where` argument doesn't exist, create a new PropositionPrix with this data.
   */
  create: Prisma.XOR<Prisma.PropositionPrixCreateInput, Prisma.PropositionPrixUncheckedCreateInput>
  /**
   * In case the PropositionPrix was found with the provided `where` argument, update it with this data.
   */
  update: Prisma.XOR<Prisma.PropositionPrixUpdateInput, Prisma.PropositionPrixUncheckedUpdateInput>
}

/**
 * PropositionPrix delete
 */
export type PropositionPrixDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PropositionPrixInclude<ExtArgs> | null
  /**
   * Filter which PropositionPrix to delete.
   */
  where: Prisma.PropositionPrixWhereUniqueInput
}

/**
 * PropositionPrix deleteMany
 */
export type PropositionPrixDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which PropositionPrixes to delete
   */
  where?: Prisma.PropositionPrixWhereInput
  /**
   * Limit how many PropositionPrixes to delete.
   */
  limit?: number
}

/**
 * PropositionPrix without action
 */
