...
async function main() {
    ...
    const course = await prisma.course.create({
        data: {
            chauffeurId: chauffeur.id,
            vehiculeId: vehicule.id,
            adresseDepart: '123 Rue de Paris, Douala',
            latitudeDepart: 4.0483,
            longitudeDepart: 9.7043,
            adresseArrivee: '45 Avenue du General, Douala',
            latitudeArrivee: 4.0583,
            longitudeArrivee: 9.7143,
            distance: 8.5,
            dureeEstimee: 20,
            prixInitial: 2625,
            prixFinal: 2500,
