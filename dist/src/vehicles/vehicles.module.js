...
exports.VehiclesModule = VehiclesModule = __decorate([
    (0, common_1.Module)({ imports: [drivers_module_1.DriversModule], controllers: [vehicles_controller_1.VehiclesController], providers: [vehicles_service_1.VehiclesService, vehicles_repository_1.VehiclesRepository], exports: [vehicles_service_1.VehiclesService, vehicles_repository_1.VehiclesRepository] })
], VehiclesModule);
